...
def default(self: Producer, events: ak.Array, **kwargs) -> ak.Array:
    ...
    for i in nummern_liste[:100]:
        ...
        for j in range(len(events[len_mask])):
            ...
            if i == events[len_mask][j].event:
                print(i)
                found = True
                if not ((events[len_mask][j].category_ids[1] == 23110) | (events[len_mask][j].category_ids[1] == 23120)): 
    ...
    # for i in nummern_liste:
    #     if i in events.event:
    #         j = events.event.index(i)
    #         if not ((events[j].category_ids[1] == 23110) | (events[j].category_ids[1] == 23120)): 
    #             print(i)
    #             print(events[j].category_ids)
